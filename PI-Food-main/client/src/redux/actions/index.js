...
//   return { type: ORDER_AZ, payload: recipes };
// };

// export const orderZA = (recipes) => {
//   return { type: ORDER_ZA, payload: recipes };
// };

// export const hsMayor = (recipes) => {
//   return { type: HS_AMAYOR, payload: recipes };
// };

// export const hsMenor = (recipes) => {
//   return { type: HS_AMENOR, payload: recipes };
// };

// export const getFilterDiet = (diet, recipes) => {
//   return { type: GET_FILTER_DIET, payload: { recipes, diet } };
// };
...
// export const pagesTotal = (pages) => {
//   return { type: TOTAL_PAGES, payload: pages };
// };

// export const setDietsFilter = (diet) => {
//   return { type: SET_DIETS_FILTER, payload: diet };
// };

// export const deleteDietsFilter = () => {
//   return { type: DELETE_DIETS_FILTER };
// };
...
//       .then((res) => res.json())
//       .then((recipes) =>
//         dispatch({ type: GET_RECIPES_NAME, payload: recipes })
//       );
//   };
// };
